      ...
      >
        ...
        >
          ...
          <div className="min-h-[460px]">
            ...
            <div className="bg-[#1D3B7A]/35 rounded-[10px] p-3 border border-[#1D3B7A]/55 flex-1 my-3 space-y-2">
...
function Card({ title, children }) {
  return (
    <div className="bg-[#1D3B7A]/35 rounded-[10px] p-3 border border-[#1D3B7A]/55 flex-1">
      <h6 className="text-sm font-normal text-[#9FB5DA]/95 mb-2">{title}</h6>
      {children}
    </div>
  );
}
...
function PItem({ l, c }) {
  return (
    <div className=" flex items-start ">
      ...
      <p className="flex-1 flex-wrap leading-[16px] text-xs text-[#E8F0FF]/90 font-normal">
        {c}
      </p>
    </div>
  );
